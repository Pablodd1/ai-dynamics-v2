        ...
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="flex gap-4 pt-2">
              <a href="https://linkedin.com/in/jasmelacosta" target="_blank" rel="noopener noreferrer" className="text-luxury-silver hover:text-luxury-gold transition-colors text-sm flex items-center gap-2">
